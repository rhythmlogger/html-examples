! function (t, e) {
    ...
    return function (t) {
        ...
        class Xo extends Zo {
            ...
            _createEvent() {
                return Fi(this._nextTick, this.floatTime + this.duration) ? this.transport.scheduleOnce(this.invoke.bind(this), new jo(this.context, this._nextTick).toSeconds()) : -1
            }
            _createEvents(t) {
                Fi(this._nextTick + this._interval, this.floatTime + this.duration) && (this._nextTick += this._interval, this._currentId = this._nextId, this._nextId = this.transport.scheduleOnce(this.invoke.bind(this), new jo(this.context, this._nextTick).toSeconds()))
            }
            _restart(t) {
                ...
                Ri(e, this.time) && (this._nextTick = this.floatTime + Math.ceil((e - this.floatTime) / this._interval) * this._interval), this._currentId = this._createEvent(), this._nextTick += this._interval, this._nextId = this._createEvent()
            }
            dispose() {
                ...
                this._state.forEachFrom(t, t => {
                    ...
                    if ("started" === t.state) {
                        ...
                        if (!0 === this._loop || ui(this._loop) && this._loop > 1) {
                            ...
                            null !== n && (e = Math.min(e, n.time - s)), e !== 1 / 0 && (e = new jo(this.context, e));
